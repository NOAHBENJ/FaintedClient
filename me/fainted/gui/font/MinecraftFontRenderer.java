...
public class MinecraftFontRenderer extends CFont {
    ...
    public int drawStringWithShadow(String text, double x2, double e, int color) {

        float shadowWidth = this.drawString(text, x2 + 0.9f, (double) e + 0.5f, color, true, 8.3f);

        return (int) Math.max(shadowWidth, this.drawString(text, x2, e, color, false, 8.3f));
    }

    public int drawString(String text, double x2, double d, int color) {
        return (int) this.drawString(text, x2, d, color, false, 8.3f);
    }
    ...
    public float drawCenteredString(String text, double d, double e, int color) {
        return this.drawString(text, d - (float) (this.getStringWidth(text) / 2), e, color);
    }
    ...
    public float drawCenteredStringWithShadow(String text, double d, double e, int color) {
        return this.drawStringWithShadow(text, d - (float) (this.getStringWidth(text) / 2), e, color);
    }
